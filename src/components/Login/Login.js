...
const Login = (props) => {
  ...
  // useReducer is used to manage multiple useState
  ...
  //   }, 500)
  //   // we have return cleanup function to clear all time intervals except last one so that it does not check for every keystrokes coz it will be very hectic for system
  //   return () => {
  //     console.log("CLEANER");
